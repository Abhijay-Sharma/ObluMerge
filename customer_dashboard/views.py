...
#kashish version with new feature by which the user can filter those customers who had credit period overdue
class PaymentFollowUpDashboardView(LoginRequiredMixin, TemplateView):
